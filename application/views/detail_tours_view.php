...
<!--								<img src="--><?php //echo base_url('/assets/upload/product/'.$product_array[$i]['slug'].'/'.$product_array[$i]['image']) ?><!--" alt="image">-->
								<img src="<?php echo base_url('assets/img/horizontal.jpg') ?>" alt="image ralated tour">
								<div class="overview">
									<div class="head">
<!--										<h4 class="post-subtitle">--><?php //echo $product_array[$i]['parent_title'] ?><!--</h4>-->
<!--										<h2 class="post-title">--><?php //echo $product_array[$i]['title'] ?><!--</h2>-->
										<h4 class="post-subtitle">Parent Title</h4>
										<h2 class="post-title">Tour Name Lorem ipsum dolor sit amet, consectetur adipiscing elit</h2>
									</div>
									<div class="body">
										<h3 class="price">
...
<!--										</small>-->
										<small class="rating" style="color: white;"><?php echo $this->lang->line('tour-detail-rating') ?>: 4/5 <i class="fa fa-star" aria-hidden="true"></i>
										</small>
									</div>
								</div>
								<div class="content">
