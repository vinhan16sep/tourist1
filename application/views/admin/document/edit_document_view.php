                ...
                <div class="box box-default">
                    <div class="box-body">
                        ...
                        <div class="form-group col-xs-12">
                            ...
                            ?>
                            <img src="<?php echo base_url('assets/upload/document/'.$detail['image']) ?>" alt="anh-cua-<?php echo $detail['slug'] ?>" style="display: block;" width=150>
                            <br>
                        </div>
                        ...
                        <div class="form-group col-xs-12">
                            <div class="form-group col-xs-12">
                                <?php
                                echo form_label('Phân Loại', 'type_shared');
                                echo form_error('type_shared');
                                echo form_dropdown('type_shared', set_value('type_shared', array(0 => 'Miễn phí', 1 => 'Yêu cầu đăng ký tài khoản')), $detail['type'], 'class="form-control"');
                                ?>
                            </div>
                        </div>
                        <div class="form-group col-xs-12">
                            <div class="form-group col-xs-12">
                                <?php
                                echo form_label('Url', 'url_shared');
                                echo form_error('url_shared');
                                echo form_input('url_shared', set_value('url_shared', $detail['url']), 'class="form-control"');
                                ?>
                            </div>
                        </div>
                        <div>
