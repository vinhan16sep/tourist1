                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group col-xs-12">
                            <div class="form-group col-xs-12">
                                ...
                                echo form_dropdown('type_shared', set_value('type_shared', array(0 => 'Miễn phí', 1 => 'Yêu cầu đăng ký tài khoản')), 0, 'class="form-control"');
                                ?>
                            </div>
                        </div>
                        <div class="form-group col-xs-12">
                            <div class="form-group col-xs-12">
                                ...
                                echo form_input('url_shared', set_value('url_shared'), 'class="form-control"');
                                ?>
                            </div>
                        </div>
                        <div>
