            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <form action="<?php echo base_url('admin/landing/index') ?>" method="get">
                            ...
                            <table id="table" class="table table_product">
                                ...
                                <?php foreach ($result as $key => $value): ?>
                                    <tr class="remove_<?php echo $value['id'] ?>">
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="dataActionDelete btn-remove" data-controller="landing" data-id="<?php echo $value['id'] ?>" ><i class="fa fa-remove" aria-hidden="true"></i> </a>
                                        </td>
